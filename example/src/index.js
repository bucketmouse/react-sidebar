...
class App extends React.Component {
  ...
  render() {
    ...
    const sidebarProps = {
      ...
      pullPosition: this.state.pullPosition,
      touchHandleSize: this.state.touchHandleSize,
        ...
        <MaterialTitlePanel title={contentHeader}>
          <div style={styles.content}>
            ...
            <ul>
              ...
              <li>
                <a href="https://github.com/balloob/react-sidebar">Source on GitHub</a> (MIT license)
              </li>
              <li>Only dependency is React</li>
            </ul>
            <p>
              <a href="https://github.com/balloob/react-sidebar#installation">Instructions how to get started.</a>
            </p>
            <p>
              <b>Current rendered sidebar properties:</b>
            </p>
            {['open', 'docked', 'transitions', 'touch', 'shadow'].map(this.renderPropCheckbox)}
            {['touchHandleSize', 'dragToggleDistance'].map(this.renderPropNumber)}
            {['touchHandleSize', 'dragToggleDistance', 'pullPosition'].map(this.renderPropNumber)}
          </div>
        </MaterialTitlePanel>
      </Sidebar>
    )
